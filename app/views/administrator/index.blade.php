                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                          <p align="center"><img src="{{ URL::asset('assets/img/logo.png') }}" width="10%" heigth="10%" class="img-responsive img-circle" alt=""></p>
                            <h1><strong>Manchester City Fanspage</strong> | Login Form</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to Manchester City Administrator</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div class="description">
                            	<p>
	                            	 Copyright © 2016. Develop By Dias | All Right Reserved
                            	</p>
                            </div>
                        </div>
                       </div>
