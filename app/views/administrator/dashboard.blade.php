@if(!Auth::check())
    <?php
    header("Location: http://localhost/uts-7792/public/administrator/index");+
    exit;
    ?>
@else
<!DOCTYPE html>
...
<div class="wrapper">
  <header class="main-header">
    <a href="media.php" class="logo">
      <span class="logo-mini"><b>PW</b>L&nbsp;</span>
      <span class="logo-lg"><b>Admin</b> &nbsp PWL</span>
    </a>
